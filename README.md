...
- In the active directory, user administrator permissions

  From the Azure Active Directory page, go to Roles and administrators. 
  Find user administrators
  Add assignment
  Select the created service principal and assign role

- In the subscription, application administator and user administrator
